...
// NewClientConfigFromConfig converts Config to k8sclient.ClientConfig
func NewClientConfigFromConfig(c *Config) *k8sclient.ClientConfig {
...
// NewCheckerConfigFromConfig converts Config to checker.CheckerConfig
func NewCheckerConfigFromConfig(c *Config) *checker.CheckerConfig {
	return &checker.CheckerConfig{
		NodeName:              c.NodeName,
		CheckTimeout:          c.CheckTimeout,
		InitialCheckTimeout:   c.InitialCheckTimeout,
